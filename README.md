...
|-----------------------|--------------------------------------------------|------------------------------------|---------------|
| **🏥 MediAI Diagnosis**  | AI-based medical imaging analysis                | Python, TensorFlow, React, AWS     | 🚀 Live        |
| **💊 PharmaTrack**       | Blockchain-backed pharmaceutical supply system   | Node.js, Ethereum, MongoDB         | ⚡ In Progress |
| **🩺 HealthVault**       | Patient records system with HIPAA compliance     | Next.js, PostgreSQL, Docker        | 🔧 Development |
| **🧬 GenomeAnalyzer**    | DNA sequence ML analysis platform                | FastAPI, Python, BioPython         | 🧪 Planning    |

<div align="center">
  <a href="https://github.com/Joeeazy?tab=repositories">
    <img src="https://img.shields.io/badge/View_All_Projects-000000?style=for-the-badge&logo=github" />
  </a>
</div>
...
## 🧬 Anime Corner (Because Passion Drives Innovation!)

<div align="center">
  <img src="https://media.giphy.com/media/MP1kygLQzjCve/giphy.gif" width="300"/>
</div>

**Faves Right Now:**
- 🧪 **Dr. Stone** – *Science + Survival*
- 🤖 **Ghost in the Shell** – *AI and Cybersecurity*
- ⚔️ **Demon Slayer** – *Epic visuals & drive*
- 🧠 **Psycho-Pass** – *AI + Law enforcement*
- 🧫 **Cells at Work!** – *Edutainment at its finest*
- 🧍‍♂️ **Monster** – *Psychological medical drama*
...
<div align="center">
  ...
  [![Medium](https://img.shields.io/badge/Medium-12100E?style=for-the-badge&logo=medium)](https://medium.com/@yourhandle)
  [![Dev.to](https://img.shields.io/badge/Dev.to-0A0A0A?style=for-the-badge&logo=devdotto)](https://dev.to/yourhandle)
